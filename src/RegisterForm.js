        ...
        return(
            <div>
			  ...
			  <div className="form-group">
			    <label htmlFor="inputEmail3" className="col-sm-2 control-label">Full Name</label>
			...
			<input type="password" className="form-control" id="inputPassword3" placeholder="Email Address"/>
			   ...
			   <div className="form-group">
			    <label htmlFor="inputEmail3" className="col-sm-2 control-label">Confirm Password</label>
			          <div className="col-sm-8">
			      <input type="email" className="form-control" id="inputEmail3" placeholder="Comfirm Password"/>
			    </div>
			  </div>
			  <div className="form-group">
